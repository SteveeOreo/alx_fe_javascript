...
function loadQuotes() {
  ...
  quotes = stored ? JSON.parse(stored) : [
    ...
    { text: "Don’t watch the clock; do what it does. Keep going.", category: "Time Management" },
    { text: "The best way to predict the future is to create it..", category: "Entrepreneurship" }
  ];
}
